...
function transformHTML(content, file) {
  ...
  while (rRElment.test(content)) {
    content = content.replace(rRElment, function(all) {
      ...
      return '<textarea style="display:none;" type="r-element" id="rs-' + index + '"><![CDATA[\n'+fn+'\n]]></textarea>';
    });
  }
